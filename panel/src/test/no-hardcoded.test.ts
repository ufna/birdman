// Guard против регрессий i18n: НИ ОДНОЙ захардкоженной кириллической строки в
// исходниках вне разрешённых мест. Любой будущий русский текст, вписанный мимо
// каталога (t()/tp()), ловится здесь в CI, а не глазами на ревью.
//
