...
// (ScrapeTargetDown/DiskHigh*/CertExpiry/Backup*) виден при любом выборе — и
// подписан чипом, иначе оператор прочитает «мастер лёг» как беду текущего
// проекта. Молча спрятать такой алерт — худший исход этого экрана. Молчащий
// мастер приходит именно ScrapeTargetDown'ом: в скрейпе есть джоб
// `birdman-master`, а правила `MasterDown` нет вовсе (`ops.md` §1 — нужен
// ВНЕШНИЙ probe). `NodeDown` тут больше не пример: с #1064 его серия несёт
// `project`, то есть он проектный.
//
