...
export function Logs() {
  ...
  // результатом устаревшего запроса. Тот же монотонный счётчик поколений
  // (seqRef), что и в LogsHistory (LogsPanel); run() вызывается императивно и
  // не привязан к эффекту, поэтому cleanup-замыкание эффекта тут не подходит.
