...
// Вне класса и вне этого диффа по границам слайса: `/v1/alerts/*` (#995, у них
// не-скрывающий фильтр и своё правило), `GET /v1/events/stream` (#999, там
// фильтра нет вовсе), сырые проксии `/v1/logs/query`·`/v1/metrics/query*`
// (#990 закрыл их дверью requireUnboundKey, сужение — #994). `/v1/projects`
// проверяется отдельно: он `?project=` не принимает вовсе.
