...
| `GET/POST /v1/registries` · `DELETE /v1/registries/{id}` | admin | приватные registry-креды для pull агентов (Реестры v1; токен write-only, раздача агентам по agentlink — `protocol.md` §1) |
