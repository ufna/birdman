...
> Дата: 07.07.2026. Спеки — источник истины для реализации итераций из `../05-runtime-iterations.md`. Расхождение кода со спекой = баг документации: чиним спеку в том же PR, что и код. Язык кода и идентификаторов — английский, доков — русский.
